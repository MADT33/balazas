		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Balanza",
									"targetURL": "#ypfzz1balanzaquimlubesasfalto-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"ypfzz1balanzaquimlubesasfalto-display": {
								"semanticObject": "ypfzz1balanzaquimlubesasfalto",
								"action": "display",
								"description": "App Fiori Balanza Quimica -  Lubes - Asfalto",
								"title": "Balanza",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=ypf.zz1balanzaquimlubesasfalto",
									"url": sap.ui.require.toUrl("ypf/zz1balanzaquimlubesasfalto")
								}
							}
						}
					}
